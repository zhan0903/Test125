...
class SSNE:
    def __init__(self, args):
        self.current_gen = 0
        self.args = args;
        self.args.crossover_prob = 0.0
        self.args.elite_fraction = 0.2
        self.args.mutation_prob = 0.9
        fastrand.pcg32_seed(args.seed)
        ...
        # if self.num_elitists < 2: self.num_elitists = 2
    ...
    def epoch(self, pop, fitness_evals):
        ...
        # print("new_elitists",new_elitists)
